            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class=""><a href="index.php">COVID-19 POLICY</a></li>
...
<section id="page-content">
    <div class="container">
        <h1>COVID Policy</h1>
        <br>
        <p>At <?php echo $name; ?> , the health and safety of our patients and staff is our top priority. We are closely
            monitoring the COVID-19 virus. Our staff is highly trained and is screening every person entering
            our sites. We are following the recommendations from the CDC as well as the local and state
            governments. When you visit any of our <?php echo $name; ?> locations, you will be asked a series of screening
            questions and have your temperature taken. Please also note a mask or face covering is required for
            anyone entering our facilities. If you do not have a mask, on will be provided to you. We will
            continue to monitor COVID-19 and make adjustments to our screening and visiting protocols so that we
            can maintain the best care possible to our patients and the community. In addition, all of our sites
            are cleaned thoroughly and frequently throughout the day, especially after each patient visit. Every
            evening all of our sites receive a deep cleaning.</p>
        <p>In response to the initial outbreak of COVID-19, we reviewed our visitor policy to protect the health
            and safety of our patients, visitors, and staff. The following changes to our visitor policy are
            still in effect:<em>We are currently requesting that patients attend appointments alone whenever
                possible. If a companion is needed for the safety of the patient, please limit this to 1 person.
                Visitors will no longer be allowed in the treatment area. Whenever possible, companions/family
                members are asked to refrain from waiting in our patient waiting areas and instead should wait
                in their cars in an effort to reduce crowding and maintain appropriate social distancing.</em>
        </p>
        <p>People battling cancer often have weakened immune systems and it is harder for their body to fight
            off an infection. It is important for those with cancer and their family members to protect
            themselves. Frequent handwashing is recommended.</p>
        <p>At <?php echo $name; ?> , we stand by our patients. If you are not feeling well, we are here for you and our
            doors remain open. If you have been exposed to someone with a confirmed case of COVID-19 in the last
            14 days, please call our office before coming to your appointment. Please call&nbsp;<a
                href="tel:<?php echo $phone2; ?>"><?php echo $phone2; ?></a>&nbsp;and your call will be answered by one of our
            highly educated and trained staff.</p>
    </div>
</section>
