            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/shedding-light-on-mens-health"> <img alt=""
                                src="media/blog/menshealth_b3F4hxx.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>June 6, 2024</span>
                        <h2><a href="news/shedding-light-on-mens-health">Shedding Light on Men&#39;s Health</a>
                        </h2>
                        <p>June is Men’s Health Month, an important time to raise awareness about men’s health
                            issues and educate about steps to improve men’s health.</p>
                        <a href="news/shedding-light-on-mens-health" class="item-link">Read More <i
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/deciding_to_be_part_of_a_clinical_trial"> <img alt=""
                                src="media/blog/clinical_trials.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>April 18, 2024</span>
                        <h2><a href="news/deciding_to_be_part_of_a_clinical_trial">Deciding to Be Part of a
                                Clinical Trial</a></h2>
                        <p>April is National Cancer Control Month, a time to raise awareness about cancer
                            prevention, early detection, improving cancer treatments, increasing the survival
                            rate of cancer, and improving the quality of life for people living with cancer.</p>
                        <a href="news/deciding_to_be_part_of_a_clinical_trial" class="item-link">Read More <i
                                class="icon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/national_cancer_control_month.php"> <img alt=""
                                src="media/blog/control.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>April 8, 2024</span>
                        <h2><a href="news/national_cancer_control_month.php">National Cancer Control Month</a>
                        </h2>
                        <p>April is National Cancer Control Month, a time to raise awareness about cancer
                            prevention, early detection, improving cancer treatments, increasing the survival
                            rate of cancer, and improving the quality of life for people living with cancer.</p>
                        <a href="news/national_cancer_control_month.php" class="item-link">Read More <i
                                class="icon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/the_beginning_of_a_new_chapter.php"> <img alt=""
                                src="media/blog/nyimg_breast.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>March 28, 2024</span>
                        <h2><a href="news/the_beginning_of_a_new_chapter.php">The beginning of a new chapter</a>
                        </h2>
                        <p>Starting a new chapter after recovering from breast cancer is an all-encompassing
                            journey filled with strength, resilience, transformation, and hope.</p>
                        <a href="news/the_beginning_of_a_new_chapter.php" class="item-link">Read More <i
                                class="icon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/early_detection_in_colorectal_cancer.php"> <img alt=""
                                src="media/blog/colorectal_FMzAJcM.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>March 6, 2024</span>
                        <h2><a href="news/early_detection_in_colorectal_cancer.php">Early Detection in
                                Colorectal Cancer</a></h2>
                        <p>March kicks off Colorectal Cancer Awareness Month, amplifying the conversation around
                            Colorectal Cancer.</p>
                        <a href="news/early_detection_in_colorectal_cancer.php" class="item-link">Read More <i
                                class="icon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
