...
<section id="page-content">
    <div class="container">
        <h1>Joint Injections</h1>
        <br>
        <p dir="ltr">&nbsp;Steroids can be injected into the joint space to treat arthritis, tendonitis, and
            bursitis.</p>
        <p dir="ltr"><span>The most common sites for steroid injections are the:</span></p>
        <ul>
            <li dir="ltr">
            ...
            <li dir="ltr">
                <p dir="ltr"><span>Knee</span></p>
            </li>
            <li dir="ltr">
                <p dir="ltr"><span>Wrist</span></p>
            </li>
            <li dir="ltr">
                <p dir="ltr"><span>Finger</span></p>
            </li>
        </ul>
        <p dir="ltr"><span>It can take up to 10 days for you to feel the full effects of the steroid. Depending
                on your condition and how your body responds, the effects can last for weeks or many few
                months.<br /><br /></span><strong>During your procedure<br /></strong>The doctor will localize
            the joint under x-ray guidance. The joint will be cleaned. A thin needle will be advanced into the
            joint. Once it is confirmed that the tip of the needle is in the joint space, the steroid mixture
            will be injected.</p>
        <p dir="ltr"><strong>After your procedure<br /></strong>You will be able to go home shortly after the
            injection.</p>
        <p dir="ltr"><span>You may have some discomfort at the site. This should get better in 24 to 48 hours.
                You can take over-the-counter pain medication if you need it. Most people don&rsquo;t need any
                pain medication.</span></p>
        <p dir="ltr"><strong>Caring for your access site<br /></strong>Do not get the area wet for 24 hours.
            After 24 hours, you can shower, but still need to avoid getting the site wet. You should not take a
            bath or swim for 3 days.</p>
