            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/its_patient_celebration_day.php"> <img alt=""
                                src="media/blog/patientday.png"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>July 10, 2023</span>
                        <h2><a href="news/its_patient_celebration_day.php">It&#39;s Patient Celebration Day</a>
                        </h2>
                        <p>Our favorite event has arrived!</p>
                        <a href="news/its_patient_celebration_day.php" class="item-link">Read More <i
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/unveiling_the_power_of_mri_and_pet_scans_in_brain_tumor_diagnosis.php">
                            <img alt="" src="media/blog/brain_nyimg.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>July 1, 2023</span>
                        <h2><a
                                href="news/unveiling_the_power_of_mri_and_pet_scans_in_brain_tumor_diagnosis.php">Unveiling
                                the Power of MRI and PET Scans in Brain Tumor Diagnosis</a></h2>
                        <p>The evolution of brain imaging, particularly the utilization of MRI and PET scans,
                            has revolutionized the field of brain tumor diagnosis.</p>
                        <a href="news/unveiling_the_power_of_mri_and_pet_scans_in_brain_tumor_diagnosis.php"
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/dr-jennifer-ripton-snyder-joins-new-york-imaging.php"> <img alt=""
                                src="media/blog/snyder_welcome_nyimg.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>June 5, 2023</span>
                        <h2><a href="news/dr-jennifer-ripton-snyder-joins-new-york-imaging.php">Dr. Jennifer
                                Ripton-Snyder Joins New York Imaging</a></h2>
                        <p>New York Imaging Specialists is thrilled to announce the addition of Dr. Jennifer
                            Ripton-Snyder, a fellowship-trained breast imager.</p>
                        <a href="news/dr-jennifer-ripton-snyder-joins-new-york-imaging.php"
                            class="item-link">Read More <i class="icon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/how-imaging-helps-in-the-detection-and-monitoring-of-cancer.php"> <img
                                alt="" src="media/blog/nyimg_safety.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>June 1, 2023</span>
                        <h2><a href="news/how-imaging-helps-in-the-detection-and-monitoring-of-cancer.php">How
                                Imaging Helps in the Detection and Monitoring of Cancer</a></h2>
                        <p>Medical imaging has emerged as a powerful and indispensable tool in the detection and
                            monitoring of cancer.</p>
                        <a href="news/how-imaging-helps-in-the-detection-and-monitoring-of-cancer.php"
                            class="item-link">Read More <i class="icon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/world-ovarian-cancer-day.php"> <img alt=""
                                src="media/blog/nyimg_ovarian.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>May 5, 2023</span>
                        <h2><a href="news/world-ovarian-cancer-day.php">World Ovarian Cancer Day: Interventional
                                Radiology for Gynecologic Malignancies</a></h2>
                        <p>The role of interventional radiology in women’s health has expanded significantly in
                            recent years.</p>
                        <a href="news/world-ovarian-cancer-day.php" class="item-link">Read More <i
                                class="icon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
