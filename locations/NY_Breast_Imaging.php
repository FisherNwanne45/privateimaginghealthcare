...
<section id="page-title" class="text-light"
    style="background-image:url(../media/location_pic/NewHydePark53.jpg); background-size: cover; background-position: center center;">
    <div class="container">
        ...
        <div class="page-title">
            <h1 style="padding-top:175px;padding-bottom:150px;"><span
                    ...
                    Breast Imaging - Lake Success</span></h1>
        </div>
    </div>
</section>
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a class="btn" style="background-color:rgb(88,59,146);border-color:rgb(88,59,146);"
                href="https://goo.gl/maps/sDfXUn2NvrMmUyX7A">Request Appointment Online</a>
            <br>
            <br>
            <div class="card">
                <div class="card-body">
                    ...
                    <h3>Address<h3>
                            ...
                            <p><a href="https://maps.google.com/?q=1%20Delaware%20Drive%2C%20New%20Hyde%20Park%2C%20NY%2011042"
                                    target="none">1 Delaware Drive, New Hyde Park, NY 11042</a></p>
                            <br>

                            <img alt="" src="../media/location_pic/NewHydePark53.jpg" style="max-width:200px;"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="map" data-latitude="40.7597117" data-longitude="-73.6940186" data-style="light"
                        data-info="Location Map for NY Breast Imaging - Lake Success"
