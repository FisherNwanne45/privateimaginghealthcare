...
<section id="page-title" class="text-light"
    style="background-image:url(../media/location_pic/NYCBS_201_puiOCoy.jpg); background-size: cover; background-position: center center;">
    <div class="container">
...
<div class="container">
    ...
    <div class="row">
        <p style="padding-top:20px;"><!-- width="560" height="315"
                src="https://www.youtube.com/embed/-Nl7iL5N76E?si=hQ62nsRFtY7p6FSN" title="YouTube video player"
                frameborder="0"
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    <h3>Phone: <a href="tel://646-597-5557">646-597-5557</a></h3>

                    <h3>Address<h3>
                            <h5><a href="https://www.google.com/maps/dir/Current+Location/40.769030,-73.960750"
                                    target="none">Directions</a></h5>
                            <p><a href="https://maps.google.com/?q=201%20E%2071st%20St%2C%20Lower%20Level%2C%20New%20York%2C%20NY%2010021"
                                    target="none">201 E 71st St, Lower Level, New York, NY 10021</a></p>
                            <br>

                            <img alt="" src="../media/location_pic/NYCBS_201_puiOCoy.jpg"
        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="map" data-latitude="40.769030" data-longitude="-73.960750" data-style="light"
                        data-info="Location Map for <?php echo $name; ?>  Manhattan"
...
<script type='text/javascript'
    src='https://maps.google.com/maps/api/js?key=AIzaSyDO6r6gm7xU2h-UI6pvUkC_e9LaOfEzrWo'></script>
...
<!-- Mirrored from <?php echo $urlh; ?>/locations/ny_imaging_manhattan by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 01:11:27 GMT -->
