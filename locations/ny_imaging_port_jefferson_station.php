 ...
 <!-- Mirrored from <?php echo $urlh; ?>/locations/ny_imaging_port_jefferson_station by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 01:11:28 GMT -->
 <!-- Added by HTTrack -->
 ...
 <head>
     ...
     <meta name="description" content="Information for our <?php echo $name; ?>  Port Jefferson Station location located at 5316 Nesconset Highway, Port Jefferson Station, NY 11776">
     <meta property="og:description" content="Information for our <?php echo $name; ?>  Port Jefferson Station location located at 5316 Nesconset Highway, Port Jefferson Station, NY 11776" />
     ...
     <title>
         ...
         <?php echo $name; ?> Port Jefferson Station
 ...
 <section id="page-title" class="text-light" style="background-image:url(../media/location_pic/4O2A4854.jpg); background-size: cover; background-position: center center;">
     <div class="container">

         <div class="page-title">
             <h1 style="padding-top:175px;padding-bottom:150px;"><span style="font-size:34pt;background-color: rgba(0,0,0,.3);padding:10px;line-height:73px;"><?php echo $name; ?> Port Jefferson Station</span></h1>
         </div>
     </div>
 </section>
 ...
 <div class="container">
     ...
     <div class="row">
         <div class="col-lg-6">
             ...
             <div class="card">
                 <div class="card-body">
                     ...
                     <h3>Address<h3>
                             <h5><a href="https://www.google.com/maps/dir/Current+Location/40.927330,-73.044380" target="none">Directions</a></h5>
                             <p><a href="https://maps.google.com/?q=5316%20Nesconset%20Highway%2C%20Port%20Jefferson%20Station%2C%20NY%2011776" target="none">5316 Nesconset Highway, Port Jefferson Station, NY 11776</a></p>
                             <br>

                             <img alt="" src="../media/location_pic/4O2A4854.jpg" style="max-width:200px;" class="img-fluid img-thumbnail">
         ...
         <div class="col-lg-6">
             ...
             <div class="card">
                 <div class="card-body">
                     <div class="map" data-latitude="40.927330" data-longitude="-73.044380" data-style="light" data-info="Location Map for <?php echo $name; ?>  Port Jefferson Station" style="max-height:350px;min-height:330px;"></div>
                 </div>
             </div>
         </div>
     </div>
