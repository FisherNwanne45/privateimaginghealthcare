...
<section id="page-title" class="text-light"
    style="background-image:url(../media/location_pic/NYBH_Slider_BetterHealth.png); background-size: cover; background-position: center center;">
    <div class="container">
        ...
        <div class="page-title">
            <h1 style="padding-top:175px;padding-bottom:150px;"><span
                    ...
                    Breast Imaging - North Massapequa</span></h1>
        </div>
    </div>
</section>
...
<div class="container">
    ...
    <div class="row">
        <p style="padding-top:20px;">The North Massapequa location will feature advanced 3D mammography, which
            offers clearer, more detailed images, improving early detection of breast cancer. Additionally,
            breast ultrasound will be available to complement mammography, especially for women with dense
            breast tissue, allowing for more comprehensive breast health evaluations.

            This Massapequa location is an important expansion, aligning with its mission to provide
            compassionate, patient-centered care with the latest medical advancements. With a convenient
            location and expert providers, the new facility is a valuable resource for the community.</p>
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h3>Address<h3>
                            <h5><a href="https://www.google.com/maps/dir/Current+Location/40.710722,-73.4613876"
                                    target="none">Directions</a></h5>
                            <p><a href="https://maps.google.com/?q=1061%20North%20Broadway%2C%201st%20Floor%2C%20North%20Massapequa%2C%20NY%2011758"
                                    target="none">1061 North Broadway, 1st Floor, North Massapequa, NY 11758</a>
                            </p>
                            <br>

                            <img alt="" src="../media/location_pic/NYBH_Slider_BetterHealth.png"
        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="map" data-latitude="40.710722" data-longitude="-73.4613876" data-style="light"
                        data-info="Location Map for NY Breast Imaging - North Massapequa"
