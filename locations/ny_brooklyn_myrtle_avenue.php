...
<section id="page-title" class="text-light"
    style="background-image:url(../media/location_pic/4O2A9624_hvd3ey0.jpg); background-size: cover; background-position: center center;">
    <div class="container">
        ...
        <div class="page-title">
            <h1 style="padding-top:175px;padding-bottom:150px;"><span
                    ...
                    Imaging Brooklyn - Myrtle Avenue</span></h1>
        </div>
    </div>
</section>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h3>Address<h3>
                            <h5><a href="https://www.google.com/maps/dir/Current+Location/40.6934549,-73.9848915"
                                    target="none">Directions</a></h5>
                            <p><a href="https://maps.google.com/?q=172%20Myrtle%20Ave%2C%20Brooklyn%2C%20NY%2011201"
                                    target="none">172 Myrtle Ave, Brooklyn, NY 11201</a></p>
                            <br>

                            <img alt="" src="../media/location_pic/4O2A9624_hvd3ey0.jpg"
        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="map" data-latitude="40.6934549" data-longitude="-73.9848915" data-style="light"
                        data-info="Location Map for <?php echo $name; ?>  Brooklyn - Myrtle Avenue"
