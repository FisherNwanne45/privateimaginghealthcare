 ...
 <!-- Mirrored from <?php echo $urlh; ?>/locations/ny_imaging_port_jefferson_building_1 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 01:11:28 GMT -->
 <!-- Added by HTTrack -->
 ...
 <head>
     ...
     <meta name="description" content="Information for our <?php echo $name; ?>  Port Jefferson (Building 1) location located at 1500 NY-112, Building 1, Port Jefferson Station, NY 11776">
     <meta property="og:description" content="Information for our <?php echo $name; ?>  Port Jefferson (Building 1) location located at 1500 NY-112, Building 1, Port Jefferson Station, NY 11776" />
     ...
     <title>
         ...
         <?php echo $name; ?> Port Jefferson (Building 1)
 ...
 <section id="page-title" class="text-light" style="background-color:rgb(110,85,196);">
     <div class="container">
         ...
         <div class="page-title">
             <h1 style="padding-top:175px;padding-bottom:150px;"><span style="font-size:34pt;background-color: rgba(0,0,0,.3);padding:10px;line-height:73px;"><?php echo $name; ?> Port Jefferson (Building 1)</span></h1>
         </div>
     </div>
 </section>
 ...
 <div class="container">
     ...
     <div class="row">
         <div class="col-lg-6">
             ...
             <div class="card">
                 <div class="card-body">
                     ...
                     <h3>Address<h3>
                             <h5><a href="https://www.google.com/maps/dir/Current+Location/40.914120,-73.031980" target="none">Directions</a></h5>
                             <p><a href="https://maps.google.com/?q=1500%20NY-112%2C%20Building%201%2C%20Port%20Jefferson%20Station%2C%20NY%2011776" target="none">1500 NY-112, Building 1, Port Jefferson Station, NY 11776</a></p>
                             <br>
         ...
         <div class="col-lg-6">
             ...
             <div class="card">
                 <div class="card-body">
                     <div class="map" data-latitude="40.914120" data-longitude="-73.031980" data-style="light" data-info="Location Map for <?php echo $name; ?>  Port Jefferson (Building 1)" style="max-height:350px;min-height:330px;"></div>
                 </div>
             </div>
         </div>
     </div>
