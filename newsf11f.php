    ...
    <div class="container">
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/ease_holiday_stress_with_self_massage_techniques.php"> <img alt=""
                                src="media/blog/selfmassage.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>Dec. 1, 2023</span>
                        <h2><a href="news/ease_holiday_stress_with_self_massage_techniques.php">Ease Holiday
                                Stress with Self Massage Techniques</a></h2>
                        <p>The Holiday hustle and bustle is upon us. It’s a joyous time of year filled with
                            gatherings, celebrations, and what can feel like a never-ending to-do list.</p>
                        <a href="news/ease_holiday_stress_with_self_massage_techniques.php"
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/east-end-health-opens-in-westhampton-beach.php"> <img alt=""
                                src="media/blog/eastend_1.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>Nov. 20, 2023</span>
                        <h2><a href="news/east-end-health-opens-in-westhampton-beach.php">East End Health and
                                Imaging Center Opens State-of-the-Art Center in Westhampton Beach</a></h2>
                        <p>East End Health and Imaging Center opens state-of-the-art center, located at 40 Main
                            Street, Westhampton Beach, NY 11978,</p>
                        <a href="news/east-end-health-opens-in-westhampton-beach.php" class="item-link">Read
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/fall_recipes.php"> <img alt="" src="media/blog/food_nyh_LYkzyNk.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>Nov. 1, 2023</span>
                        <h2><a href="news/fall_recipes.php">Fall Recipes</a></h2>
                        <p></p>
                        <a href="news/fall_recipes.php" class="item-link">Read More <i
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/vascular_and_interventional_radiology.php"> <img alt=""
                                src="media/blog/national_library.png"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>Oct. 4, 2023</span>
                        <h2><a href="news/vascular_and_interventional_radiology.php">Vascular and Interventional
                                Radiology</a></h2>
                        <p>Outpatient percutaneous image-guided microwave ablation with monitored anesthesia
                            care: An exploratory study</p>
                        <a href="news/vascular_and_interventional_radiology.php" class="item-link">Read More <i
                                class="icon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/national_mammography_day.php"> <img alt=""
                                src="media/blog/mammo_yogUrQN.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>Oct. 2, 2023</span>
                        <h2><a href="news/national_mammography_day.php">National Mammography Day</a></h2>
                        <p>National Mammography Day is an annual event on the third Friday of October each year
                            when women are encouraged to schedule mammograms so that their breasts can be
                            examined.</p>
                        <a href="news/national_mammography_day.php" class="item-link">Read More <i
                                class="icon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class='center'>
            <ul class="pagination">
                ...
                <li class="page-item"><a class="page-link" href="newse556.php?offset=15"><i
