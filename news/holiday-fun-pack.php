                    ...
                    <div class="post-item">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                ...
                                <a href="#">
                                    <img alt="" src="../media/blog/holidayhousecover.jpg">
                                </a>

                            </div>
                            <div class="post-item-description">
                                <h1>Printable Holiday Fun Pack</h1>
                                <div class="post-meta">
                                    <span class="post-meta-date"><i class="fa fa-calendar-o"></i>Dec. 20,
                                        2022</span>
                                </div>
                                <p>Download and print these Holiday printable coloring pages.</p>
                                <p>Print one out for yourself, or print one for someone in your life who could
                                    use some holiday cheer!</p>
                                <p>Click <a href="../media/assets/Holiday_Fun_Pack.pdf" target="_blank">here</a>
                                    to download!&nbsp;</p>
                                <p>&nbsp;</p>
                                <p>&nbsp;</p>
                                <p>&nbsp;</p>
