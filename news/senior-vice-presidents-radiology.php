                    ...
                    <div class="post-item">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                ...
                                <a href="#">
                                    <img alt="" src="../media/blog/VP_pic.jpg">
                                </a>

                            </div>
                            <div class="post-item-description">
                                <h1>Senior Vice Presidents of Radiology</h1>
                                <div class="post-meta">
                                    <span class="post-meta-date"><i class="fa fa-calendar-o"></i>Aug. 1,
                                        2022</span>
                                </div>
                                <p><?php echo $name; ?> announced today the appointments of Tim Wintz and
                                    Jarett Greenside to Senior Vice Presidents of Radiology. Wintz and Greenside
                                    will oversee the <?php echo $name; ?> service line, which extends from the east end of
                                    Long Island to the five boroughs of New York City. Wintz and Greenside will
                                    continue to uphold the standard of excellence in imaging, ensuring patients
                                    have the best possible performance outcomes at each imaging center.</p>
                                <p>&ldquo;We are excited to provide support to our patients, staff, and
                                    referring physicians,&rdquo; Wintz said. &ldquo;Our vision is to make NY
                                    Imaging Specialists the standard for imaging.&rdquo;</p>
                                <p>Wintz has been with <?php echo $name; ?> since July 2019, previously
                                    serving as Director of MRI. Wintz has over 13 years of clinical and
                                    operational radiology experience. He graduated from Peconic Bay School of
                                    Radiologic Technology.&nbsp;Greenside continued, &ldquo;Our new roles allow
                                    us to support patients and team members at each location with a higher level
                                    of detail to deliver the highest quality of patient-centered care.&rdquo;
                                    Jarett Greenside has been with NYCBS since April 2020, previously serving as
                                    Director of CT and IR.</p>
                                <p>Greenside has over 12 years of clinical and operational experience. He
                                    received a bachelor&rsquo;s degree in Mass Communications from SUNY Oswego,
                                    graduated from Mercy Medical Center School of Radiography, completed an
                                    Advanced Certificate in Healthcare Management, and earned a master&rsquo;s
                                    degree in Healthcare Administration from Stony Brook University.</p>
                                <p>&ldquo;Tim and Jarett are both strong character individuals and take the
                                    incredible initiative to work meticulously to ensure that our patients have
                                    the best experience while at our imaging centers,&rdquo; said Jeff Vacirca,
                                    MD, CEO. &ldquo;They have truly demonstrated their leadership
                                    qualities.&rdquo;</p>
                            </div>
