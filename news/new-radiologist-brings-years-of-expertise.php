                    ...
                    <div class="post-item">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                ...
                                <a href="#">
                                    <img alt="" src="../media/blog/comito600x400.jpg">
                                </a>

                            </div>
                            <div class="post-item-description">
                                <h1>New Radiologist Brings Years of Expertise to the Practice</h1>
                                <div class="post-meta">
                                    <span class="post-meta-date"><i class="fa fa-calendar-o"></i>Aug. 1,
                                        2022</span>
                                </div>
                                <p dir="ltr">Board-certified Radiologist Dr. Matthew Comito has experience in
                                    all facets of advanced abdominal and pelvic imaging. He specializes in
                                    hepatobiliary, genitourinary, pancreas, and prostate imaging. Additionally,
                                    Dr. Comito has extensive training and expertise in MRI for rectal cancer
                                    staging, lymphoma, and inflammatory bowel disease.</p>
                                <p dir="ltr">Dr. Comito completed a Diagnostic Radiology residency at Stony
                                    Brook University Hospital, serving as the chief resident. After residency,
                                    he completed a fellowship in Abdominal Imaging and Intervention at Duke
                                    University Medical Center, where he trained with world experts in prostate,
                                    hepatobiliary, and pancreas imaging. As a multidisciplinary team member at
                                    Duke&rsquo;s nationally-ranked urological oncology program, Dr. Comito has
                                    gained extensive experience in even the most complex prostate cancer
                                    imaging.&nbsp;</p>
                                <p dir="ltr">We are delighted to have Dr. Comito join our radiology
                                    department.&nbsp;</p>
                                <p><span>&nbsp;</span></p>
                            </div>
