                    ...
                    <div class="post-item">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                ...
                                <a href="#">
                                    <img alt="" src="../media/blog/eastend_1.jpg">
                                </a>

                            </div>
                            <div class="post-item-description">
                                <h1>East End Health and Imaging Center Opens State-of-the-Art Center in
                                    Westhampton Beach</h1>
                                <div class="post-meta">
                                    <span class="post-meta-date"><i class="fa fa-calendar-o"></i>Nov. 20,
                                        2023</span>
                                </div>
                                <p dir="ltr"><span>East End Health and Imaging Center is proud to announce the
                                        opening of its cutting-edge healthcare facility in Westhampton Beach,
                                        NY, offering a wide range of health and imaging services.</span></p>
                                <p>This state-of-the-art center, located at <strong>40 Main Street, Westhampton
                                        Beach, NY 11978,</strong> is dedicated to providing Long Island's East
                                    End with the latest surgical breast care and advanced diagnostic imaging.
                                </p>
                                <p>"We are excited to introduce East End Health and Imaging Center to
                                    Westhampton Beach and the entire East End of Long Island," said Dr. Jeff
                                    Vacirca, CEO. "The new center is driven by the need in the community for
                                    increased access to high-quality care and medical imaging services.&rdquo;
                                </p>
                                <p>The technologically advanced and well-designed imaging center assures
                                    community members easy access to affordable imaging services, including 3D
                                    mammogram, ultrasound, MRI, and image-guided breast biopsy.</p>
                                <p>The center is staffed by Surgical Oncologist Dr. David P. Mangiameli,
                                    renowned for his dedication to enhancing breast cancer screening for
                                    high-risk patients, minimally invasive breast surgery, oncoplastic surgery,
                                    and the customization of cancer surgery for each unique individual.
                                    Alongside him is fellowship-trained Dr. Krystal Airola, an expert in breast
                                    imaging, committed to providing personalized, high-quality patient
                                    care.&nbsp;</p>
                                <p>To schedule an appointment, <strong>please call (631) 998-2500 for Imaging or
                                        (631) 508-5795 for Breast Surgery</strong>. For more information about
                                    East End Health and Imaging Center, please visit our website at
                                    EastEndImaging.com.</p>
                            </div>
