                    ...
                    <div class="post-item">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                ...
                                <a href="#">
                                    <img alt="" src="../media/blog/comito_nyimg.jpg">
                                </a>

                            </div>
                            <div class="post-item-description">
                                <h1>New York Imaging Specialists Names Dr. Matthew Comito Named Chief Radiology
                                    Officer</h1>
                                <div class="post-meta">
                                    <span class="post-meta-date"><i class="fa fa-calendar-o"></i>Feb. 16,
                                        2023</span>
                                </div>
                                <p dir="ltr"><span>New York Imaging Specialists is proud to announce that
                                        radiologist Matthew Comito, MD, has been appointed Chief Radiology
                                        Officer.</span></p>
                                <p>&ldquo;Dr. Comito has the administrative, scientific, clinical, leadership,
                                    and visionary skills needed to move the Department of Radiology
                                    forward,&rdquo; said Jeff Vacirca, MD, CEO.</p>
                                <p><?php echo $name; ?> offers advanced medical imaging services, including
                                    MRI, CT, PET/CT, ultrasound, mammography, interventional radiology, and more
                                    at multiple locations spanning from Manhattan to Montauk. Under his
                                    leadership, Dr. Comito will oversee all aspects of radiologic services,
                                    including diagnostic imaging and nuclear medicine, while maintaining the
                                    center&rsquo;s high-quality standards and optimizing workflows and
                                    efficiency.</p>
                                <p>Dr. Comito has expertise in all facets of abdominal and pelvic imaging with
                                    special interests in hepatobiliary, genitourinary, pancreas, and prostate
                                    MRI as well as extensive experience in MRI for rectal cancer staging,
                                    lymphoma, and inflammatory bowel disease.&nbsp;</p>
                                <p>Dr. Comito completed a Diagnostic Radiology residency at Stony Brook
                                    University Hospital, where he served as chief resident. After residency, he
                                    completed a fellowship in Abdominal Imaging and Intervention at Duke
                                    University Medical Center. Throughout his training, he gained expertise in
                                    prostate, hepatobiliary, and pancreas imaging.</p>
                                <p>&ldquo;It is an honor to take on this position as Chief Radiology
                                    Officer,&rdquo; Dr. Comito said. &ldquo;I am privileged to work with a team
                                    of outstanding radiologists, technologists, and administrators. I look
                                    forward to supporting the continued rapid growth of <?php echo $name; ?> while making
                                    expert patient care our main priority.&rdquo;</p>
                                <p><span>&nbsp;</span></p>
                            </div>
