                    ...
                    <div class="post-item">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                ...
                                <a href="#">
                                    <img alt="" src="../media/blog/patientday.png">
                                </a>

                            </div>
                            <div class="post-item-description">
                                <h1>It&#39;s Patient Celebration Day</h1>
                                <div class="post-meta">
                                    <span class="post-meta-date"><i class="fa fa-calendar-o"></i>July 10,
                                        2023</span>
                                </div>
                                <p dir="ltr"><span>Our favorite event has arrived for its 10th year!! Join us
                                        Saturday, September 9th, for the 10th Annual Patient Celebration Day at
                                        the Bald Hill Amphitheater from 12- 4 PM! </span></p>
                                <p dir="ltr">This fun-filled day for patients, caregivers, and their families is
                                    expected to have over 1,500 people attending this special event this year.
                                    NYCBS will support this event, placing no burden on patients and caregivers.
                                    Any support remaining from this event will be donated directly to the New
                                    York Cancer Foundation to continue to help oncology patients with their
                                    household bills.</p>
                                <p dir="ltr">We are actively looking for volunteers! Head over to&nbsp;<a
                                        class="c-link" href="http://nycancerfoundation.org/"
                                        rel="noopener noreferrer" target="_blank"
                                        data-stringify-link="http://nycancerfoundation.org"
                                        data-sk="tooltip_parent">nycancerfoundation.org</a>&nbsp;to sign up to
                                    volunteer!Attendees will enjoy family-friendly activities, including new
                                    rides, live music, carnival games, raffles, catering by Felicos, and an area
                                    dedicated to Working Paws Training, a dog training and adoption center!!.
                                </p>
                                <p dir="ltr">The event will also have a pop-up store where patients can find
                                    free clothes, shoes, and wigs! We can&rsquo;t wait to see you there!</p>
                            </div>
