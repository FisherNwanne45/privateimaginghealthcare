        ...
        $inspiroSlider.each(function () {
          ...
          elem.options = {
            ...
            pauseAutoPlayOnHover:
              elem.data("hoverpause") == false ? false : true,
            adaptiveHeight:
  ...
  INSPIRO.elements = {
        ...
        $ajaxForm.each(function () {
          ...
          elem.submit(function (event) {
            ...
            if (elem[0].checkValidity() === false) {
              ...
              button.php('<i class="icon-loader fa-spin"> </i> Sending...');
              $.ajax({
                url: post_url,
                type: request_method,
                data: form_data,
    ...
    gridLayoutInfinite: function (element, elementSelector, elemGridMargin) {
      ...
      var elem = element,
        ...
        loadMoreBtnText = $("#showMore a.btn").php(),
        loadMoreMessage = $(
          '<div class="infinite-scroll-message"><p class="animated visible fadeIn">No more posts to show</p></div>'
        );

      var pathSelector = $(".infinite-scroll > a").attr("href");
      if (pathSelector.indexOf(".php") > -1) {
      ...
      elem.on("append.infiniteScroll", function (event, response, path, items) {
        ...
        loadMoreBtn.php(loadMoreBtnText);
        element.css(
          "margin",
    ...
    countdown: function () {
      ...
      if ($countdown.length > 0) {
        $countdown.each(function () {
          ...
          $elemCount.find(".count-number").php($elemSeconds);
          new Waypoint({
            element: $elem,
            handler: function () {
        ...
        $subscribeForm.each(function () {
          ...
          elem.submit(function (event) {
            ...
            if (elem[0].checkValidity() === false) {
              ...
              $(elem).removeClass("was-validated");
              addonIcon.php('<i class="icon-loader fa-spin"></i>');
              $.ajax({
                url: post_url,
                type: request_method,
                data: form_data,
