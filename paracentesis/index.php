...
<section id="page-content">
    <div class="container">
        <h1>Paracentesis</h1>
        <br>
        <p dir="ltr"><span>During a paracentesis fluid that has built up in your abdomen (belly) is removed.
                This can help to relieve pain and difficulty breathing. The active part of the procedure usually
                takes less than 10 minutes. It can take up to 30 additional minutes for all of the fluid to be
                drained depending on how much was in your belly. The fluid is sometimes sent to the laboratory
                to be analyzed.</span></p>
        <p dir="ltr"><span>During your procedure</span></p>
        <p dir="ltr"><span>The interventional radiologist will look with ultrasound to find the area with the
                most fluid. This area will be cleaned and numbed with local anesthetic (lidocaine/novocaine). A
                needle or small catheter (plastic tube) will be inserted into the fluid. If you have a large
                amount of fluid, then a wire may be used to exchange for a slightly larger catheter. Even the
                largest catheter that we use is skinnier than a pencil.</span></p>
        <p dir="ltr"><span>Once enough fluid has been drained, the catheter will be removed, and skin glue
                (Dermabond&reg;) or a small bandage will be placed over the puncture site.</span></p>
        <p dir="ltr"><span>After Your Procedure</span></p>
        <p dir="ltr"><span>When your procedure is over, you will rest in our recovery area for a short time.
                Tell your doctor or nurse if you feel dizzy or lightheaded.</span></p>
        <p dir="ltr"><span>You may have some pain or discomfort. Talk to your doctor or nurse about pain
                medications you can take, such as Tylenol&reg; and Advil&reg;.</span></p>
        <p dir="ltr"><span>Do not get the area wet for 24 hours. After 24 hours, you can shower, but should
                still avoid getting the site wet. You should not take a bath or swim for at least 3 days.</span>
        </p>
        <p dir="ltr"><span>It can sometimes be normal for a small amount of fluid to leak from the puncture site
                after your procedure. Your doctor or nurse will give you bandages to protect your clothing in
                case this happens. If fluid is still leaking from the puncture site 24 hours (1 day) after your
                procedure, call your doctor or nurse.</span></p>
    </div>
</section>
