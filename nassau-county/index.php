            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class=""><a href="index.php">Nassau County</a></li>
...
<section id="page-content">
    <div class="container">
        ...
        <br>
        <p dir="ltr"><img src="../media/assets/image5.jpg" alt="" width="800" height="500" /></p>
        <p dir="ltr"><?php echo $name; ?> in Nassau County combines diagnostic imaging, cancer support
            services, and women&rsquo;s health, all under one roof. The comprehensive center at 1 Delaware Drive
            in Lake Success combines state-of-the-art cancer services, diagnostic imaging, interventional
            radiology (IR), and a women&rsquo;s health center. No other facility on Long Island offers a variety
            of advanced treatments and technology together in one place, delivering an unparalleled experience
            to patients with tailored and personalized care.</p>
        <h3><strong>NY Breast Imaging</strong></h3>
        <p dir="ltr"><span>NY Breast Imaging is dedicated to breast health, including the prevention, detection,
                and treatment of breast cancer, offering the most comprehensive breast imaging services,
                including 3D mammography, breast ultrasound, and breast MRI.&nbsp;</span></p>
        <p>Our board-certified radiologists are leaders in the field of breast imaging, working closely with a
            multidisciplinary team of specialists to provide the highest quality and most personalized care
            possible.</p>
        <p>Our women&rsquo;s health center offers 3D Mammography, breast MRI, and breast ultrasound. And because
            your comfort is important to us, we provide a welcoming environment, complete with a&nbsp; dedicated
            women&rsquo;s waiting room, designated rooms adorned with pink wall murals, and plush robes for a
            spa-like atmosphere.</p>
        <p><span><span><img src="../media/assets/NewHydePark_Lobby_4.jpg" alt="" width="800"
                        height="500" /></span></span></p>
        <p><span><span><br /></span></span><strong>Address</strong></p>
        <p dir="ltr"><a title="1 Delaware Dr, New Hyde Park, NY 11042"
                href="https://www.google.com/maps/place/NY+Imaging+Specialists/@40.7597117,-73.6940186,15z/data=!4m2!3m1!1s0x0:0x45fe8223c196acdf?sa=X&amp;ved=2ahUKEwi0qd-T0rf5AhV9jYkEHWrbCOYQ_BJ6BAg_EAc"
                target="_self"><span>1 Delaware Drive, New Hyde Park, NY 11042</span></a></p>
