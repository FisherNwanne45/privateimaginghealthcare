            ...
            <ul>
                ...
                <li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class=""><a href="index.php">Mammography</a></li>
...
<section id="page-content">
    <div class="container">
        ...
        <br>
        <p>
            <!-- title="YouTube video player" src="https://www.youtube.com/embed/qSUp5cGAAwI" frameborder="0"
                width="560" height="315">-->
        </p>
        <h4 style="text-align: left;" dir="ltr">&nbsp;</h4>
        <h4 style="text-align: left;" dir="ltr"><strong>The center combines diagnostic imaging, cancer support
                services, and women&rsquo;s health, all under one roof.&nbsp;</strong></h4>
        <p>&nbsp;</p>
        <!--<h4 style="text-align: left;" dir="ltr"><img style="float: right; padding: 20px;"
                src="../media/assets/safirheadshot.jpg" alt="" width="200" height="267" /></h4>
        <h4 style="text-align: left;" dir="ltr"><img style="float: right; padding: 20px;"
                src="../media/assets/Tobin-2.jpg" alt="" width="200" height="267" /></h4>-->
        <p style="text-align: left;" dir="ltr">NY Breast Imaging is dedicated to breast health, including
            preventing, detecting, and treating breast cancer. We offer the most comprehensive breast imaging
            services with advanced 3D mammography, breast ultrasound, and breast MRI equipment.&nbsp;</p>
        <p dir="ltr"><span>Our board-certified radiologists are leaders in the field of breast imaging, working
                closely with a multidisciplinary team of specialists to provide the highest quality and most
                personalized care possible.</span></p>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <p>Breast Biopsy</p>
                <p>Breast MRI &ndash; Magnetic resonance imaging (MRI) of the breast uses radio waves to produce
                    detailed pictures of the structures within the breast. MRIs screen women at high risk for
                    breast cancer, evaluate the extent of cancer following diagnosis, or further evaluate
                    abnormalities seen on mammography.&nbsp;</p>
                <p>Breast Ultrasound</p>
                <p>3D Mammography &ndash; Mammograms are low-dose x-rays that can help find breast cancer. Our
                    services include digital screening and diagnostic mammography. This state-of-art-technology
                    will ensure that you receive the most effective imaging possible.&nbsp;</p>
            </div>
            <div class="col-lg-4">
                <div class="call-to-action call-to-action-colored">
                    <h3>What To Expect: Mammogram</h3>
                    <p>More information and instructions for this procedure.</p>
                    <a class="btn btn-outline btn-light" href="../what-to-expect/mammogram.php">Learn More</a>
                </div>
            </div>
        </div>
