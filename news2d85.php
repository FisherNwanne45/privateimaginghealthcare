            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/psma-pet-ct-scan-improves-prostate-cancer.php"> <img alt=""
                                src="media/blog/psmapet.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>Aug. 15, 2022</span>
                        <h2><a href="news/psma-pet-ct-scan-improves-prostate-cancer.php">PSMA PET/CT Scan
                                Improves Prostate Cancer Detection and Treatment</a></h2>
                        <p>PSMA PET/CT Scans are improving how the extent of prostate cancer spread is detected
                            and treated.</p>
                        <a href="news/psma-pet-ct-scan-improves-prostate-cancer.php" class="item-link">Read More
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/senior-vice-presidents-radiology.php"> <img alt=""
                                src="media/blog/VP_pic.jpg"> </a>



                    </div>
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>Aug. 1, 2022</span>
                        <h2><a href="news/senior-vice-presidents-radiology.php">Senior Vice Presidents of
                                Radiology</a></h2>
                        <p>Senior Vice Presidents of Radiology</p>
                        <a href="news/senior-vice-presidents-radiology.php" class="item-link">Read More <i
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        ...
                        <a href="news/new-radiologist-brings-years-of-expertise.php"> <img alt=""
                                src="media/blog/comito600x400.jpg"> </a>
                    ...
                    <div class="post-item-description"> <span class="post-meta-date"><i
                                class="fa fa-calendar-o"></i>Aug. 1, 2022</span>
                        <h2><a href="news/new-radiologist-brings-years-of-expertise.php">New Radiologist Brings
                                Years of Expertise to the Practice</a></h2>
                        <p>Board-certified Radiologist Dr. Matthew Comito has experience in all facets of
                            advanced abdominal and pelvic imaging.</p>
                        <a href="news/new-radiologist-brings-years-of-expertise.php" class="item-link">Read More
                            <i class="icon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
