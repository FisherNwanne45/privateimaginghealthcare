                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu"><span class="dropdown-arrow"></span><a
                                href="#">Physicians</a>
                            <ul class="dropdown-menu">
                                <li class=""><a href="index.php">INFINITT</a></li>
...
<section id="page-content">
    <div class="container">
        <h1>INFINITT</h1>
        <br>
        <p dir="ltr"><span>The </span><span>INFINITT Healthcare physician portal conveniently allows physicians
                and staff to see patients&rsquo; appointments and the status of patients&rsquo; scans. The
                system allows for accurate diagnoses and maximizes clinical efficiency.&nbsp;</span></p>
        <p><img src="../media/assets/radiinfinittportal.jpg" alt="" /></p>
        <p><span><span>&nbsp;</span></span></p>
        <p dir="ltr">Login here:<a title="Login Here" href="https://nycbs.infinittna.com/IPHY/Pages/Login">
                https://nycbs.infinittna.com/IPHY/Pages/Login</a></p>
        <p><span><span>&nbsp;</span></span></p>
        <ul>
            <li dir="ltr">
                <p dir="ltr"><span>If you&rsquo;re in need of support, or r</span>equire a log-in, please
                    contact <a href="mailto:<?php echo $email; ?> "><?php echo $email; ?> </a>, with your full name,
                    email address, organization, and callback number.</p>
            </li>
            <li dir="ltr">
                <p dir="ltr"><span>Please note that you need to sign a BAA/NDA to obtain access to the
                        portal.&nbsp;</span></p>
            </li>
        </ul>
    </div>
