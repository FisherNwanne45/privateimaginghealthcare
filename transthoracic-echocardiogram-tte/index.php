                ...
                <li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class=""><a
                                ...
                                Therapies</a></li>
                        <li class=""><a href="index.php">Transthoracic Echocardiogram (TTE)</a>
                        </li>
...
<section id="page-content">
    <div class="container">
        <h1>TRANSTHORACIC ECHOCARDIOGRAM (TTE)</h1>
        <br>
        <p><span><img src="../media/assets/tte.jpg" alt="" width="100%" /></span></p>
        <p><span>What is a Transthoracic Echocardiogram (TTE)?<br /></span>&ndash; A TTE is a noninvasive
            ultrasound &ndash; using high-frequency soundwaves to create moving images<br />of your heart
            through the chest wall.<br />&ndash; There is NO radiation when getting a TTE.<br />&ndash; A TTE
            gives your doctor a good view of your overall heart health.<br />o Evaluates heart size<br />o
            Evaluates the amount of blood being pumped out of your heart<br />o Evaluates valve function<br />o
            Evaluates for injury to the heart muscle</p>
        <p><span><em>What to expect during your Transthoracic Echocardiogram (TTE)?<br /></em></span>&ndash;
            There is no special preparation required before your exam.<br />&ndash; This exam may take up to 1
            hour to complete.<br />&ndash; You will be attached to electrodes in order to monitor your heart
            rate and electrical activity during the exam.<br />&ndash; You will be laying down for most of this
            exam and positioned on your side when possible to obtain optimal imaging.</p>
        <p><br />Unlike other radiology exams &ndash; your TTE will be read by a Cardiologist as opposed to a
            Radiologist.</p>
    </div>
</section>
